...
public class SortMergeOperator extends JoinOperator {
     ...
     * a materialized operator. Otherwise, simply returns the right source. Note
    ...
    private class SortMergeIterator implements Iterator<Record> {
        ...
        */
        ...
        private Record fetchNextRecord() {
            ...
            // Implement the sort-merge join pseudocode as described in
            // slide 'Joins Final' of the course.    ----By hjt
            Record record;
            ...
            if (compare(leftRecord, rightRecord) == 0) {
                record = leftRecord.concat(rightRecord);
                if (rightIterator.hasNext()) {
                    rightRecord = rightIterator.next();
                } else {
                    rightIterator.reset();
                    rightRecord = rightIterator.next();
                    marked = false;    // TODO may be wrong at here.
