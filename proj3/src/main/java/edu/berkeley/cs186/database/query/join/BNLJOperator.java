...
public class BNLJOperator extends JoinOperator {
    ...
    private class BNLJIterator implements Iterator<Record>{
        ...
        private void fetchNextLeftBlock() {
            ...
            Schema leftSourceSchema = getLeftSource().getSchema();
            leftBlockIterator = QueryOperator.getBlockIterator(leftSourceIterator, leftSourceSchema, numBuffers - 2);
        ...
        private void fetchNextRightPage() {
            ...
            Schema rightSourceSchema = getRightSource().getSchema();
            rightPageIterator = QueryOperator.getBlockIterator(rightSourceIterator, rightSourceSchema, 1);
        ...
        private Record fetchNextRecord() {
            ...
            while (true) {
                if (rightPageIterator.hasNext()) {
                    ...
                    // Case 4: Neither right page nor left block iterators have
                    // values nor are there more right pages, but there may have left blocks.
                    if (!leftSourceIterator.hasNext()) {
                        // There don't have left blocks.
                        return null;
                    }
                    fetchNextLeftBlock();
